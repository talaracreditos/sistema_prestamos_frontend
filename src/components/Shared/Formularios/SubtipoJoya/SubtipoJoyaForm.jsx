...
const SubtipoJoyaForm = ({ data, handleChange }) => {
    return (
        <div className="bg-white dark:bg-dark-surface p-6 sm:p-8 rounded-2xl shadow-sm dark:shadow-black/25 border border-slate-100 dark:border-dark-border transition-colors">
            <h3 className="text-base font-black text-slate-800 dark:text-dark-text flex items-center gap-2 mb-6 uppercase tracking-wide border-b border-slate-100 dark:border-dark-border pb-3 transition-colors">
                <TagIcon className="w-6 h-6 text-brand-red dark:text-brand-gold" /> Información del Subtipo de Joya
            </h3>

            <div className="space-y-6">
                <div>
                    <label className="block text-xs font-bold text-slate-500 dark:text-dark-text-muted uppercase mb-2 ml-1 transition-colors">
                        Descripción *
                    </label>
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder="EJ: CORDON, DIJE, ARETE"
                            required
                        />
                    </div>
                </div>
...
export default SubtipoJoyaForm;