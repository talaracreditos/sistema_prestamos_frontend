...
import { useIndex } from 'hooks/SubTipoJoya/useIndex';
...
const Index = () => {
    const {
        ...
        handleFilterChange, handleFilterSubmit, handleFilterClear, fetchSubtiposJoyas
    } = useIndex();
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 transition-colors">
            <PageHeader title="Subtipos de Joyas" icon={SparklesIcon} buttonText="+ Nuevo Subtipo" buttonLink="/subtipo-joya/agregar" />
            ...
            <div className="relative z-10">
                <Table
                    ...
                    pagination={{ ...paginationInfo, onPageChange: fetchSubtiposJoyas }}
                />
            </div>

            {showDelete && (
                <ConfirmModal
                    title="¿Eliminar Subtipo de Joya?"
