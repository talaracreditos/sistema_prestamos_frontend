...
import { useUpdate } from 'hooks/SubTipoJoya/useUpdate';
...
const Update = () => {
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 transition-colors">
            <PageHeader
                title="Editar Subtipo de Joya"
                subtitle={`Modificando: ${formData.descripcion}`}
                icon={PencilSquareIcon}
                buttonText="← Volver"
                buttonLink="/subtipo-joya/listar"
            />
            ...
            <form onSubmit={handleSubmit} className="mt-6 max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-4 mt-8">
                    <button
                        type="button"
                        onClick={() => navigate('/subtipo-joya/listar')}
