// pages/CajaChicaGasto/Update.jsx
import React from 'react';
import { useUpdate } from 'hooks/CajaChicaGasto/useUpdate';
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 transition-colors">
            <PageHeader
                ...
                buttonText="← Volver"
                buttonLink="/caja-chica-gasto/listar"
            />
            
            <AlertMessage type={alert?.type} message={alert?.message} details={alert?.details} onClose={() => setAlert(null)} />
            
            <form onSubmit={handleSubmit} className="mt-6 max-w-3xl mx-auto">
                <CajaChicaGastoForm data={formData} handleChange={handleChange} />

                <div className="flex flex-col sm:flex-row justify-end gap-4 mt-8">
                    <button type="button" onClick={() => navigate('/caja-chica-gasto/listar')}
