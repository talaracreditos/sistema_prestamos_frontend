            ...
            render: (row) => (
                <div className="flex flex-col gap-1 items-start">
                    ...
                    {row.estado === 2 && row.cuadro !== null && (
                        <span className={`px-2 py-0.5 text-[9px] font-black rounded-full border uppercase transition-colors ${
                            row.cuadro ? 'bg-green-50 dark:bg-green-500/10 text-green-600 dark:text-green-400 border-green-100 dark:border-green-500/20' : 'bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 border-red-100 dark:border-red-500/20'
                        }`}>
