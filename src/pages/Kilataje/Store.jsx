...
import { useStore } from 'hooks/Kilataje/useStore';
...
const Store = () => {
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 transition-colors">
            <PageHeader title="Nuevo Kilataje" icon={SparklesIcon} buttonText="Volver" buttonLink="/kilataje/listar" />
            ...
            <form onSubmit={handleSubmit} className="mt-6 max-w-2xl mx-auto">
                ...
                <div className="mt-8 flex justify-end">
                    <button type="submit" disabled={loading}
                        ...
                        {loading ? 'Procesando...' : 'Registrar Kilataje'}
                    </button>
                </div>
            </form>
        </div>
